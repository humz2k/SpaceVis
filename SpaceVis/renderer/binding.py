...
def draw_frame(cam_pos,cam_rot,e,im_x,im_y,coords,interp_radius,box_size,x_reps=2,y_reps=2,z_reps=2):
    ...
    cpp_renderer.draw_frame(out_ptr,cam_pos,cam_rot,e,cim_x,cim_y,interp_radius,coords_ptr,n_coords,box_size,x_reps,y_reps,z_reps)
